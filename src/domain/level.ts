...
export const clawMachineLevel: LevelDefinition = {
  ...
  number: 1,
  title: "CLAW MACHINE",
  subtitle: "Infer depth from incomplete views",
  seed: 1001,
  bounds,
  ...
  objects: [
    ...
    object("key-2", "key", "a key", "key", { x: 2, y: 4, z: 0 }, 0),
    object("key-3", "key", "a key", "key", { x: 5, y: 6, z: 0 }, 0),
    object("plush-1", "plushie", "pink bear", "bear", { x: 3, y: 2, z: 2 }, 10),
    object("plush-2", "plushie", "yellow duck", "duck", { x: 2, y: 4, z: 2 }, 10),
    object("plush-3", "plushie", "blue frog", "frog", { x: 5, y: 6, z: 2 }, 10),
