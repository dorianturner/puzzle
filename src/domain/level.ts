...
/** A compact second level used to verify registry navigation and authored-data reuse. */
export const calibrationLevel: LevelDefinition = {
  id: "calibration-bay",
  number: 2,
  ...
  viewUnlocks: [
    { keyId: "cal-key-1", view: "YZ" },
    { keyId: "cal-key-2", view: "XY" },
  ],
  objects: [
    object("cal-key-1", "key", "a key", "key", { x: 2, y: 1, z: 0 }, 0),
    object("cal-key-2", "key", "a key", "key", { x: 4, y: 0, z: 0 }, 0),
    object("cal-key-3", "key", "a key", "key", { x: 6, y: 0, z: 0 }, 0),
    object("cal-plush-1", "plushie", "violet bear", "bear", { x: 2, y: 1, z: 2 }, 10),
    object("cal-plush-2", "plushie", "green duck", "duck", { x: 4, y: 0, z: 2 }, 10),
    object("cal-plush-3", "plushie", "pink frog", "frog", { x: 6, y: 0, z: 2 }, 10),
    object("cal-plush-4", "plushie", "small blob", "blob", { x: 1, y: 3, z: 1 }, 10),
    object("cal-plush-5", "plushie", "small cat", "cat", { x: 3, y: 4, z: 1 }, 10),
    object("cal-plush-6", "plushie", "small rabbit", "rabbit", { x: 5, y: 2, z: 1 }, 10),
    object("cal-plush-7", "plushie", "small bear", "bear", { x: 7, y: 5, z: 1 }, 10),
    object("cal-plush-8", "plushie", "small duck", "duck", { x: 8, y: 1, z: 1 }, 10),
  ],
  canonicalSolution: [
    action("player", "RIGHT"),
    action("bot_a", "RIGHT"),
...
export const LEVELS: readonly LevelDefinition[] = [clawMachineLevel, calibrationLevel];
